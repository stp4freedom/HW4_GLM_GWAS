...
```
###  **Rapid run options**
After running GWASapply_rapid you can always create individual plots as shown below. This option gives you more flexibility over the output and can help for specific analyses. 
